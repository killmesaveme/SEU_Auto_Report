...
def Autoreport(uname,pwd):
    ...
    bmturl="http://ehall.seu.edu.cn/appShow?appId=4815356910091974"
    #yuyue="http://yuyue.seu.edu.cn/eduplus/order/order/initEditOrder.do?sclId=1&dayInfo=2021-08-14&itemId=7&time=14:00-15:00"
    #yuyue="http://yuyue.seu.edu.cn/eduplus/order/order/getOrderInfo.do?sclId=1"
    yuyue="http://yuyue.seu.edu.cn/eduplus/order/order/initEditOrder.do?sclId=1&dayInfo=2021-08-14&itemId=7&time=14:00-15:00"
    ...
    #print(r.text)
    r2=req.get(bmturl,headers=webheader)
    text=etree.HTML(r2.text).xpath('/html/head/script[1]/text()')
    jumpurl=re.findall("(https?:.*)'", r2.text)[0]
    #print(jumpurl)
    jump=req.get(jumpurl,headers=webheader)
    print(jump.text)
    r2=req.get(yuyue,headers=webheader)
    print(r2.text)
